void readHum() {
  Serial.print("Read outdoor humidity: ");
  ...
  char httpaddr[100];
  strcpy (httpaddr, "http://192.168.1.190:8123/api/states/sensor.satenas_luftfuktighet?api_password=");
